...
var startGame = function() {
    ...
    for(var i = 0; i < enemyNames.length; i++) {
        ...
        if (playerHealth > 0) {
            ...
            // pass the pickedEnemyName varibles value into the fight function, where it will assume the value of the enemyName parameter
...
var endGame = function() {
    if (playerHealth > 0) {
        window.alert("Great job, you'be survived the game! You now have a score of " + playerMoney + ".");
    }
    else {
    ...
    switch (shopOptionPrompt) {
        ...
        case "upgrade":
            if (playerMoney >= 7) {
                ...
                window.alert("You don't ahve enough moneu!");
            }
